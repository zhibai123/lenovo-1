                ...
                <div class="panel-body">
                    ...
                    <form action="/regCheck" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="password" name="pass" id="" autocomplete="new-password" >
                        </div>
                        <div class="form-group">
                            <label for="">REPASS</label>
                            <input class="form-control" type="password" name="repass" id="" autocomplete="new-password" >
                        </div>
                        <div class="form-group">
