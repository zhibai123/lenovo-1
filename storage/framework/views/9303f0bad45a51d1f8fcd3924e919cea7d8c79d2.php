...
<div class="box-01">
    ...
    <div class="box-a" id="box-a">
        ...
        <div id="addressList-SH">
            ...
            <?php $__currentLoopData = $addr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dizhi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="list" id="52771" style="border-bottom: none;">
    ...
    <p class="list-a">
        <a title="<?php echo e($shop['goodsInfo']->title); ?>" href="/goods/<?php echo e($shop['id']); ?>">
            <img title="<?php echo e($shop['goodsInfo']->title); ?>" width="110px" src="/Uploads/goods/<?php echo e($shop['goodsInfo']->img); ?>">
        </a>
    </p>
    <p class="list-b">
